...
// -------------------------------------------------------------------------
// 3. MAIN COMPONENT (With flexible props while preserving default behavior)
// -------------------------------------------------------------------------
...
const MarqueeRow: React.FC<{ items: string[] }> = ({ items }) => (
...
export function CinematicFooter({
  ...
  const defaultPrimaryActions: ActionLink[] = [
    {
      label: "Download iOS",
      href: "#",
      icon: (
  ...
  const defaultSecondaryLinks: ActionLink[] = [
  ...
  const secondary = secondaryLinks ?? defaultSecondaryLinks;
      ...
      >
        ...
        <footer className="fixed bottom-0 left-0 flex h-screen w-full flex-col justify-between overflow-hidden bg-background text-foreground cinematic-footer-wrapper">
          ...
          <div className="relative z-10 flex flex-1 flex-col items-center justify-center px-6 mt-20 w-full max-w-5xl mx-auto">
            <h2
              ref={headingRef}
              className="text-4xl sm:text-5xl md:text-7xl lg:text-8xl font-black footer-text-glow tracking-tighter mb-8 md:mb-12 text-center max-w-4xl"
            >
              {heading}
            </h2>
              ...
              <div className="flex flex-wrap justify-center gap-4 w-full">
                {actions.map((action, index) => (
                  <MagneticButton
                    ...
                    className="footer-glass-pill px-8 md:px-10 py-4 md:py-5 rounded-full text-foreground font-bold text-sm md:text-base flex items-center gap-3 group"
                  >
                    {action.icon}
                    {action.label}
                  </MagneticButton>
          ...
          <div className="relative z-20 w-full pb-8 px-6 md:px-12 flex flex-col md:flex-row items-center justify-between gap-6">
            ...
            <div className="footer-glass-pill px-6 py-3 rounded-full flex items-center gap-2 order-1 md:order-2 cursor-default border-border/50">
              ...
              <span className="text-foreground font-black text-xs md:text-sm tracking-normal ml-1">{craftedBy}</span>
            </div>
