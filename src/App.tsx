...
import { ScrollRevealIntro } from './sections/ScrollRevealIntro';
...
export const App: React.FC = () => {
  return (
    <div className="relative w-full bg-background min-h-screen text-foreground font-sans selection:bg-primary/25 selection:text-primary overflow-x-hidden">
      ...
      {/* 
        00: SCROLL REVEAL INTRO — Grand entrance page.
        The very first thing users see. Scroll down to reveal the main portfolio.
      */}
      <ScrollRevealIntro />
